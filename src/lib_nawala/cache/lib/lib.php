...
/**
 * Nawala Framework NCacheLib Class
 * 
 * @throws NCacheException
 *
 * @package       Framework
 * @subpackage    Cache
 * @since         1.2
...
class NCacheLib
{
	 ...
	 * @return boolean
	 */
	public function addDriver($name, NCacheLibDriver &$driver, $default = TRUE)
	{
	...
	public function getDriver($name = NULL)
	{
		...
		throw new NCacheException('No driver strategy set!');
	}
