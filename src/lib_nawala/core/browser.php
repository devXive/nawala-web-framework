...
/**
 * Nawala Framework NCoreBrowser Class
 *
 * @package       Framework
 * @subpackage    Browser
 * @since         1.0
...
class NCoreBrowser
{
	...
	/**
	 * Create possible filenames related to the users operating system and used browser
	 */
	protected function createChecks()
	{
		$this->_checks = array(
			// '', // filename || Removed because the base file always be checked first in all scripts
			...
			'.' . $this->name . '-' . $this->shortversion, // short browser version check alternative
