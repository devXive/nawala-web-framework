...
/**
 * Nawala Framework NCompiler Class
 *
 * @package       Framework
 * @subpackage    Less
 * @since         1.0
...
class NCompilerLess
{
	...
	protected function injectVariables($args) {
		$this->pushEnv();
		/** NRDK -- BEGIN CHANGE * */
			$parser = new NCompilerLessParser($this, __METHOD__);
		/** NRDK -- END CHANGE * */
	...
	protected function makeParser($name) {
		/** NRDK -- BEGIN CHANGE * */
		$parser = new NCompilerLessParser($this, $name);
		/** NRDK -- END CHANGE * */
	...
	protected function newFormatter() {
		/** NRDK -- BEGIN CHANGE * */
		$className = "NCompilerLessFormatterLessjs";
		/** NRDK -- END CHANGE * */
		if (!empty($this->formatterName)) {
			if (!is_string($this->formatterName))
				return $this->formatterName;
			/** NRDK -- BEGIN CHANGE * */
			$className = "NCompilerLessFormatter" . ucfirst($this->formatterName);
			/** NRDK -- END CHANGE * */
		}
