...
// Register autoloader for Less.php library
...
/**
 * Nawala Framework NCompilerLessAdapter Class
 * 
 ...
 *  - Symfony 2
 *  - Nawala Rapid Development Kit 1+2
 *  - Gantry Framework 4
 *  - @TODO Joomla/Akeeba FOF
 *
 * @package       Framework
 * @subpackage    Compiler
 * @since         1.2
 */
class NCompilerLessAdapter
{
	...
	/**
	 * Set the @import path/s. This will override the paths already added. Use addImportDir to add more paths
	 * 
	 * @param    string|array    $dirs    Set inital single path (string) or an array of paths
	 */
	...
	/**
	 * Add one more @import path. Already added paths still exists and will not be overwritten. If you wish to overwrite the path/s use setImportDir instead
	 * 
	 * @param    string    $dir    Set one more single path (string)
	 */
