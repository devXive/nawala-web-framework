...
// grid-fluid.less
		$gantryHelper->addStyle('bootstrap.css', false, 6);
...
$test = $gantryHelper;
		...
		$lessVariables = array(
			...
			'layout-mode'    => $gantry->get('iconfont',    '100fluid')
		);

//		$gantryHelper->setVariables($lessVariables);


// $test = $gantryHelper->addLess( 'gantry/1200responsive.less' );
// $test = $gantryHelper->addImport( array('global.less', 'font-awesome.less', 'font-awesome.less', 'font-awesome.less') );
