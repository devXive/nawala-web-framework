...
class JFormFieldDebugLink extends JFormField
{
	...
	protected function getInput()
	{
		...
		if (is_file($log_file_path)) {
			$html[] = $log_file_path.'<br/>(<a href="' . JUri::root(true) . '/plugins/system/nawala/fields/debuglink/download.php?logfile=' . $this->element['logfile'] . '">'.JText::_('PLG_SYSTEM_NAWALA_DOWNLOAD').'</a>)';
		} else {
