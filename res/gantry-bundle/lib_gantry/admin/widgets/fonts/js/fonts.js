...
new Request.JSON({url:e,onSuccess:function(k){for(var m=0,j=k.items.length;m<j;m++){f=k.items[m].family;c="";if(!k.items[m].variants.contains("regular")){c=":"+k.items[m].variants[0];
